...
libmm-venc-inc      += $(TOP)/device/xiaomi/fog/hals/media/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += device/xiaomi/fog/hals/media/mm-core/inc
libmm-venc-inc      += device/xiaomi/fog/hals/media/libstagefrighthw
libmm-venc-inc      += device/xiaomi/fog/hals/media/libplatformconfig
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += device/xiaomi/fog/hals/media/libc2dcolorconvert
